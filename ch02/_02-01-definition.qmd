...
![The outcomes in the event $B$ that also belong to the event $A$](ch02/images/fig-2-1.png){#fig-2-1}
...
![The intersections of $A$ with events $B_1, \ldots, B_5$ of a partition in the proof of @thm-2-1-4](ch02/images/fig-2-2.png){#fig-2-2}
