...
including likelihood ratio tests. For instructors not interested in the more mathematical
theory of hypothesis testing, it should now be easier to skip from
...
challenging parts.
. I emphasized the closeness of a hypergeometric distribution with a large number
of available items to a binomial distribution.
xi
xii Preface
...
needs.
In addition to the text, the publisher has an Instructor’s Solutions Manual, available
for download from the Instructor Resource Center at www.pearsonhighered
...
Siong Tan, Pennsylvania University; Kanapathi Thiru, University of Alaska; Kenneth
