...
![$B = A ∪ (B ∩ Ac)$ in the proof of @thm-1-5-4.](images/fig-1-8.png){#fig-1-8}
...
![The two events of interest in utility demand sample space for @exm-1-5-4.](images/fig-1-9.png){#fig-1-9}
