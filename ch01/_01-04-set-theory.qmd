...
![The event $A^c$](ch01/images/fig-1-1.png){#fig-1-1}

![The set $A \cup B$](ch01/images/fig-1-2.png){#fig-1-2}
...
![The set $A \cap B$.](ch01/images/fig-1-3.png){#fig-1-3}
...
![Partition of $S$ determined by three events $A_1$, $A_2$, $A_3$.](ch01/images/fig-1-4.png){#fig-1-4}
