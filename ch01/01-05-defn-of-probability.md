---
title: "The Definition of Probability"
label: sec-1-5
---
...
# Definition 1.5.1: Probability

A **probability measure**, or simply a **probability**, on a sample space $S$ is a specification of numbers $\Pr(A)$ for all events $A$ that satisfy Axioms [-@prp-1], [-@prp-2], and [-@prp-3].
...
![$B = A \cup (B \cap A^c)$ in the proof of @thm-1-5-4.](ch01/images/fig-1-8.svg){#fig-1-8}
...
![The two events of interest in utility demand sample space for @exm-1-5-4.](ch01/images/fig-1-9.svg){#fig-1-9 width="60%"}
...
Consider two events $A$ and $B$ such that $\Pr(A) = 1/3$ and $\Pr(B) = 1/2$. Determine the value of $\Pr(B \cap A^c)$ for each of the following conditions: **(a)** $A$ and $B$ are disjoint; **(b)** $A \subset B$; **(c)** $\Pr(A \cap B) = 1/8$.
