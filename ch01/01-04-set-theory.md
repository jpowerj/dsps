...
In order to be mathematically correct without imposing an undue burden on
the reader, we note the following. In order to be able to do all of the probability calculations
...
![The set $A \cap B$.](ch01/images/fig-1-3.svg){#fig-1-3 width="50%"}
...
# Definition 1.4.9: Intersection of Many Sets

The **intersection** of n sets A1, . . . ,An is defined to be the
...
![Partition of $S$ determined by three events $A_1$, $A_2$, $A_3$.](ch01/images/fig-1-4.svg){#fig-1-4 width="50%"}

::: {.callout-tip}
::: {#exm-1-4-4}

# Example 1.4.4: Tossing a Coin
