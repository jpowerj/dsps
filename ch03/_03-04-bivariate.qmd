...
![The joint pmf of $X$ and $Y$ in @exm-3-4-3](images/fig-3-10.jpeg){#fig-3-10}
...
Any function that satisfies the two displayed formulas in @thm-3-4-3 is the joint
pdf for some probability distribution.
