...
Suppose that $X$ and $Y$ are independent random variables with the following pdf's:
...
Suppose that $X$ and $Y$ are i.i.d. random variables, and that each has the following pdf:
...
Suppose that $X_1, \ldots, X_n$ are i.i.d. random variables, each having the following CDF:
...
24. Suppose that $X_1$, $X_2$, and $X_3$ form a random sample of three observations from a distribution having the following pdf:
